...
//import com.capgemini.librarymanagementsystemhibernate.dto.AdminInformation;

public class LibraryManagementSystemControllerHibernate {
	
	public static void main(String[] args) {
				hibernateController();
			}	
			public static void hibernateController() {
...
//											System.out.println("email-----> "+adminLogin.getEmail());
...
//											System.out.println("role-----> "+userInfo.getRole());
											...
											do {
												...
												switch (controller1) {
												case 1:
													UserInformation userInfo1 = LibraryManagementSystemFactory
															.getUserInfo();
													...
													userInfo1.setPassword(userPassword);
													...
													userInfo1.setDepartment(userDepartment);
													...
													userInfo1.setRole(userRole);

														boolean add = adminService.addUser(userInfo1);
														if (add) {
												...
												case 3:
													try {
														...
														Iterator<UserInformation> iterator = listUsers.iterator();
														while (iterator.hasNext()) {

															UserInformation userInfo2  = (UserInformation) iterator.next();

															System.out.println("User id ---------- " + userInfo2.getUserId());
															System.out.println("User name------ " + userInfo2.getUsername());
															System.out.println("User Email------ " + userInfo2.getEmail());
															System.out
																	.println("User password------ " + userInfo2.getPassword());
															System.out.println(
																	"User department------ " + userInfo2.getDepartment());
															System.out.println("User Role------ " + userInfo2.getRole());
															System.out.println("*****************");
														}
													} catch (Exception e) {
												...
												case 4:
													try {
														...
														Iterator<BooksInformation> iterator = listBooks.iterator();
														while (iterator.hasNext()) {

															BooksInformation bookInfo3 = (BooksInformation) iterator.next();
												...
												case 5:
													try {
														...
														List<UserRequestInformation> requestInfo1 = adminService
																.showAllRequests();
														Iterator<UserRequestInformation> iterator = requestInfo1.iterator();
														while (iterator.hasNext()) {

															UserRequestInformation info = (UserRequestInformation) iterator.next();
								...
								//							System.out.println("Book Returned------>" + info.isBookReturned());
														...
														System.out.println("no request present in library");
													e.printStackTrace();
													}
													break;
								...
								//	}
									...
									System.out.println("please enter valid credentials in case of admin");
									hibernateController();
								}
								break;
...
//									if ("student".equalsIgnoreCase(role)) {
											...
											do {
												...
												case 3:
													...
													try {
														...
														System.out
																.println("User name--->" + userInfo.getUserId());
														System.out.println("Book Id----->" + bookInfo.getBookId());
														System.out
																.println("Book Name--->" + bookInfo.getBookName());
						...
						System.out.println("please enter valid credentials InputMismatchException");
						hibernateController();
					} catch (NoSuchElementException nsee) {
						System.out.println("please enter valid credentials NoSuchElementException");
						hibernateController();
					} catch (Exception e) {
						System.out.println("please enter valid credentials Exception");
						hibernateController();
					}
